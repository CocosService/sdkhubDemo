...
export const conf = {
    ...
    google: {
      // Configuring In-App Purchases in the Google Play console.
      productId: "",
      // inapp or subs
      skuType: "inapp",
      // Configuring Leaderboard in the Google Play console.
      leaderboardId: "",
      // Configuring Achievements in Google Play console.
      achievementId: "",
    },
...
// ["this level", "upper level", "button1", "button2", ...]
    ...
    //second menu
    user : ["user", "top", "return", "init", "checkAppUpdate", "login",  "loginWithAuthorizationCode", "loginWithIDToken", "slientLogin", "getCurrentPlayer", "logout", "showToolBar", "hideToolBar", "getUserInfo", "showAchievements", "unlockAchievement", "submitScore", "showLeaderBoard", "cancelAuthorization", "submitEvent", "getEvent", "submitPlayerEventStart", "getPlayerExtraInfo", "submitPlayerEventEnd", "getGamePlayerStats", "getGameSummary", "setPopupsPosition", "getAppId", "cancelGameService", "smsStartConsent", "revoke"],
    fee : ["fee", "top", "return", "feeForProduct", "isEnvReady", "obtainProductInfo", "consumeOwnedPurchase", "obtainOwnedPurchases", "obtainOwnedPurchaseRecord", "startIapActivity", "consume"],
